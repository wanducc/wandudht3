...
class Master(Thread):
    def __init__(self):
        ...
        self.pool = PooledDB(MySQLdb,50,host=DB_HOST,user=DB_USER,passwd=DB_PASS,db=DB_NAME,port=int(DB_PORT),charset="utf8mb4") #50为连接池里的最少连接数
...
if __name__ == "__main__":
    ...
    dht = DHTServer(master, "0.0.0.0", 6881, max_node_qsize=Getspeed)
    dht.start()
